...
class _ChatHistoryState extends State<ChatHistory> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppWidgets.appBar(context, 'Annie Go', leading: AppWidgets.backArrow(context), actions: [
        Icon(
        ...
        child: PagedListView<int, ChatHistoryModel>.separated(
          ...
          builderDelegate: PagedChildBuilderDelegate<ChatHistoryModel>(itemBuilder: (BuildContext context, ChatHistoryModel item, int index) {
            return Column(
              ...
              Text(item.sender?.name?.name??'',style: FlutterFlowTheme.of(context).bodyMedium.override(
                fontFamily: 'Roboto',
