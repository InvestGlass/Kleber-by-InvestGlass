      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            TextFormField(
              readOnly: true,
              decoration: AppStyles.inputDecoration(context,focusColor: FlutterFlowTheme.of(context).customColor4,contentPadding: EdgeInsets.all(15),prefix: Container(
                height: 50,
                width: 60,
            ...
            TextFormField(
              readOnly: true,
              decoration: AppStyles.inputDecoration(context, prefix: Container(
                height: 50,
                width: 60,
                alignment: Alignment.center,
                decoration: BoxDecoration(
            ...
            Row(
              ...
              children: [
                ...
                AppWidgets.btn(context, FFLocalizations.of(context).getText(
                  'h2vfcolj' /* Transmit */,
                ), horizontalPadding: rSize * 0.02,bgColor: FlutterFlowTheme.of(context).primary),
              ],
            )
          ],
        ),
